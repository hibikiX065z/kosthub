...
@section('content')
    ...
    <div class="container mt-5 pt-5" style="max-width: 800px;">
            ...
            <form action="{{ route('pemilik.kos.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted">
                        Posisikan pin untuk menampilkan alamat kos. Silakan lengkapi dengan nomor rumah dan RT/RW jika belum
                        ada.
                    </small>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="biaya_tambahan" class="form-control" placeholder="Contoh: Listrik, Air, Kebersihan">
        </div>

        <button class="btn btn-warning w-100 rounded-pill py-2 fw-bold" style="background:#FFA125;">
            Tambah Kost
        </button>
